...
const KNOWN_ERROR_CODE_MESSAGES: Readonly<Record<string, string>> = {
  ...
  SESSION_REPLACED: 'Tu sesión se cerró porque se inició sesión en otro dispositivo o navegador.',
  SESSION_REVOKED: 'Tu sesión fue cerrada por seguridad. Inicia sesión nuevamente.',
  SESSION_REQUIRED: 'Tu sesión necesita actualizarse. Inicia sesión nuevamente.',
