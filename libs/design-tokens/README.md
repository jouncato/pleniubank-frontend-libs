...
- Carga en apps: `@import` desde `styles.scss` de **customer-portal** y **backoffice-portal** (ruta relativa al paquete `design-tokens`).
- Fuentes corporativas: pendiente de assets; por ahora se usa `system-ui` / stack sans-serif en `:root`.
