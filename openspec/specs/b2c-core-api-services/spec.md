# b2c-core-api-services

## Purpose

Servicios data-access de `core-data-access` para el cliente persona (B2C): transferencias,
extractos customer-scoped y notificaciones, tipados contra los modelos de `core-domain` y
consistentes con el contrato real ya implementado en `pleniubank-core`.
