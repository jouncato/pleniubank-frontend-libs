...
La lib `design-tokens` tiene 16 líneas y los tokens reales viven dispersos como variables
CSS ad-hoc en portal y libs; el mockup b2c-mobile-first define un sistema visual que aún
no está codificado. Esta capacidad establece `design-tokens` como fuente única de verdad
del catálogo de diseño, exportado tanto en CSS como en TypeScript.
